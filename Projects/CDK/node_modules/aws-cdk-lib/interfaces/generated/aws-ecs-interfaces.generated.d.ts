 ...
 * @stability experimental
 */
export interface IDaemonRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a Daemon resource.
     */
    readonly daemonRef: DaemonReference;
}
/**
 * A reference to a Daemon resource.
 *
 ...
 * @stability experimental
 */
export interface IDaemonTaskDefinitionRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a DaemonTaskDefinition resource.
     */
    readonly daemonTaskDefinitionRef: DaemonTaskDefinitionReference;
}
/**
 * A reference to a DaemonTaskDefinition resource.
 *
 ...
 * @stability external
 */
export interface DaemonTaskDefinitionReference {
    /**
