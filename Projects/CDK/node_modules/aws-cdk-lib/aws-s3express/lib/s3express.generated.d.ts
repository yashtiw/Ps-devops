...
export declare class CfnDirectoryBucket extends cdk.CfnResource implements cdk.IInspectable, IDirectoryBucketRef, cdk.ITaggableV2 {
     ...
     * The inventory configuration for an Amazon S3 Express bucket.
     */
    get inventoryConfigurations(): Array<CfnDirectoryBucket.InventoryConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The inventory configuration for an Amazon S3 Express bucket.
     */
    set inventoryConfigurations(value: Array<CfnDirectoryBucket.InventoryConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Container for lifecycle rules. You can add as many as 1000 rules.
     */
...
export declare namespace CfnDirectoryBucket {
    ...
    interface InventoryConfigurationProperty {
         ...
         */
        readonly destination: CfnDirectoryBucket.DestinationProperty | cdk.IResolvable;
        /**
...
export interface CfnDirectoryBucketProps {
     ...
     */
    readonly inventoryConfigurations?: Array<CfnDirectoryBucket.InventoryConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Container for lifecycle rules. You can add as many as 1000 rules.
     *
     * For more information see, [Creating and managing a lifecycle configuration for directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-objects-lifecycle.html          ) in the *Amazon S3 User Guide* .
