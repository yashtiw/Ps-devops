...
export declare class ContainerDefinition extends Construct {
     ...
     */
    get portMappings(): PortMapping[];
    /**
     * The data volumes to mount from another container in the same task definition.
     */
    get volumesFrom(): VolumeFrom[];
    /**
     * An array of ulimits to set in the container.
     */
    get ulimits(): Ulimit[];
     ...
     */
    get containerDependencies(): ContainerDependency[];
    /**
    ...
    private readonly _portMappings;
    private readonly _volumesFrom;
    private readonly _ulimits;
    private readonly _containerDependencies;
    /**
