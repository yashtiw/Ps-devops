...
import type { IFragmentConcatenator, IPostProcessor, IResolvable, IResolveContext, ITokenResolver } from '../resolvable';
...
export declare function writePropertyAssignmentMetadataForConstruct(scope: IConstruct, fn: () => any, lookupTable: IPropertyNameLookupTable): void;
export interface IPropertyNameLookupTable {
    cfnPropertyName(cdkPropertyName: string): string | undefined;
}
export declare class PropertyAssignmentMetadataWriter extends DefaultTokenResolver {
    private readonly lookupTable;
    private readonly seenDocumentPaths;
