...
export declare function addConstructMetadata(construct: Construct, props: any): void;
...
export declare function addPropsAsMetadata(construct: Construct, type: MetadataType, props: any): void;
/**
